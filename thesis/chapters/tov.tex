...
\end{equation}
From \eqref{eq:Pc_const_density}, the central pressure is finite only if $3\,\Phi_{R}-1>0$, i.e.
\begin{equation}
\Phi_{R}>\frac{1}{3}
