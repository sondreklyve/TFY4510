...
R \ge \frac{9}{4}M.
\]
In the case of a uniform--density star, this limit appears very clearly: as the radius gets close to $\tfrac{9}{4}M$ from above, the central pressure grows without bound ($P_{c} \to \infty$).


\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{figures/pressure_analytical_buchdahl.pdf}
...
The constant--density star provides an analytic solution of the TOV
equations and a clear comparison with the Newtonian limit.  In the
relativistic case, the pressure profile
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{figures/pressure_analytical_incompressible.pdf}
