...
\par\raggedleft
Walt Whitman, \emph{When I Heard the Learn’d Astronomer}\cite{Whitman1867}
\end{quote}
...
stars and derive the Tolman-Oppenheimer-Volkov (TOV) equations \cite{tolman1939,oppenheimer1939}.
